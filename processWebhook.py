...
def webhook():
    ...
    if query_result.get('action') == 'register.data':
        ...
        p1_2_institucionalidad = float(query_result.get('parameters').get('p1_2_institucionalidad'))
        p1_institucionalidad = str(p1_1_institucionalidad/p1_2_institucionalidad)
        ...
        p1_2_infraestructura = float(query_result.get('parameters').get('p1_2_infraestructura'))
        p1_infraestructura = str(p1_1_infraestructura/p1_2_infraestructura)
